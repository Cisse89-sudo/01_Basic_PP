...
/***** Variablen 01 *******/
// let myVariable = 1;
// var anotherVariable = "HI!";
// const myConstant = 42;
// console.log(myVariable, anotherVariable, myConstant);   
/**
 * 
 * 
 * 
...
// const test2 = test; // Konstante : Deklaration + Wertzuweisung
// console.log(test2);
//     for (let i = 0; i < 3; i++) {
//         console.log(test); 
//         test = 42; // Überschreiben mit neuem Datentyp
//         console.log(test2);
//         console.log(test);
//     }
...
// console.log(`Hi, ich bin ${firstName} ${familyName}!`); // Ausgabe mit Template-String (ES6)

// firstName = 2;
// console.log("Mein Vorname ist jetzt:", firstName);
// firstName = true;
// console.log("Mein Vorname ist jetzt:", firstName);
...
// for (var i = 0; i < 3; i++) {
//     setTimeout(function() {
//         console.log("var i ist:", i);
//     }, 100);
// }

// for (let i = 0; i < 3; i++) {
//     setTimeout(function() {
//         console.log("let i ist:", i);
//     }, 100);
// }
